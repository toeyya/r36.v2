...
<?php if($cond): ?>
 <div id="report">
	...
	<div class="right"><button class="column-chart img" name="column"></button>
		<a href="report/analyze/index/3<?php echo '?'.$_SERVER['QUERY_STRING'].'&excel=excel' ?>" class="excel" name="btn_excel"></a></div> 
	...
	<table class="tbreport">
		...
		<tr><th rowspan="<?php echo $row; ?>"><?php echo $head; ?></th>			
		</tr>				
		<tr>
		...
		<?php endforeach; ?>
			...
			<div id="btn_printout">
			<a href="report/analyze/index/3<?php echo '?'.$_SERVER['QUERY_STRING'].'&p=preview' ?>"><img src="images/printer.gif" width="16" height="16" align="absmiddle" style="border:none" />&nbsp;พิมพ์รายงาน</a></div>
