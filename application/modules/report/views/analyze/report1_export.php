	...
	<table class="tbreport" border="1" width="864">
		...
		<tr valign="top"><th rowspan="<?php echo $row; ?>"><?php echo $head; ?></th></tr>				
		<tr>
		...
		<tr class="para1">
			...
			<td valign="top"><?php echo number_format(${'main'.$i.$j}); ?><br/><?php echo compute_percent(${'main'.$i.$j},${'total_main'.$i},1) ?>
				<?php $sum[$j]=	${'main'.$i.$j};			
