	...
	<span>รายงานผู้สัมผัสโรครายเดือน</span></br>
	...
	<span>สถานบริการ <?php echo $texthospital;?>  ปี  <?php echo $textyear_start;?></span>				
	</div>	
	<table class="tbreport" border="1" width="864">
		...
		<tr><td  colspan="13" height="10px;"><strong>เพศ</strong></td></tr>
		<tr class="para1">
		...
		<tr ><td  colspan="13" height="10px;"><strong>กลุ่มอายุ</strong></td></tr>
		...
		<tr ><td  colspan="13" height="10px;"><strong>สถานที่สัมผัสโรค</strong></td></tr>
		...
		<tr><td  colspan="13" height="10px;"><strong>ชนิดสัตว์นำโรค</strong></td></tr>
	<?php $animal = array(1=>'สุนัข',2=>'แมว',3=>'ลิง',4=>'ชะนี',5=>'หนู',6=>'อื่นๆ',7=>'ไม่ระบุ'); ?>	
		...
		<tr ><td  colspan="13" height="10px;"><strong>อายุสัตว์</strong></td></tr>	
	...
	<tr><td  colspan="13" height="10px;"><strong>การกักขัง / ติดตามดูอาการสัตว์</strong></td></tr>	
		<?php 
		...
		?>
		<tr class="para1">
			<td style="padding-left:10px;">กักขังได้ / ติดตามได้</td>	
			<?php  for($j=1;$j<13;$j++): ?>
	...
	<tr><td  colspan="13" height="10px;"><strong>ประวัติการฉีดวัคซีนป้องกันโรคพิษสุนัขบ้า</strong></td></tr>	
		<tr class="para1">
		...
		<tr class="para1">
			<td style="padding-left:10px;"  colspan="13" height="10px;">เคยฉีด 1 ครั้งสุดท้าย</td>		
		</tr>
		<tr class="para1">
	...
	<tr><td  colspan="13" height="10px;"><strong>สาเหตุที่ถูกกัด</strong></td></tr>	
		<tr class="para1">
			<td style="padding-left:10px;">ถูกกัดโดยไม่มีสาเหตุโน้มนำ</td>	
			<?php  for($j=1;$j<13;$j++): ?>
		...
		<tr class="para1">
			<td style="padding-left:10px;"  colspan="13" height="10px;">ถูกกัดโดยมีสาเหตุโน้มนำ</td>
	...
	<tr><td  colspan="13" height="10px;"><strong>การล้างแผลก่อนพบเจ้าหน้าที่สาธารณสุข</strong></td></tr>	
		<tr class="para1">
		...
		<tr class="para1">
			<td style="padding-left:10px;"  colspan="13" height="10px;">ล้าง</td>	
	...
	<tr><td  colspan="13" height="10px;"><strong>การใส่ยาฆ่าเชื้อก่อนพบเจ้าหน้าที่สาธารณสุข</strong></td></tr>	
		<tr class="para1">
		...
		<tr class="para1"><td style="padding-left:10px;"  colspan="13" height="10px;">ใส่ยา</td>	</tr>
	...
	<tr><td  colspan="13" height="10px;"><strong>ประวัติการฉีดวัคซีนป้องกันโรคพิษสุนัขบ้าของผู้สัมผัส</strong></td></tr>	
		<tr class="para1">
		...
		<tr class="para1"><td style="padding-left:10px;"  colspan="13" height="10px;">เคยฉีด 3 เข็มหรือมากกว่า</td>	</tr>
		...
		<tr><td  colspan="13" height="10px;"><strong>สัญชาติ</strong></td></tr>	
		...
		<?php for($i=1;$i<12;$i++){ ?>
		<tr class="para1">
			<td style="padding-left:10px;"><?php echo  $name[$i] ?></td>
			<?php  for($j=1;$j<13;$j++){ ?>
...
<?php 	$name=array(1=>"นักเรียน นักศึกษา",2=>"ในปกครอง",3=>"เกษตร ทำนา ทำสวน",4=>"ข้าราชการ",5=>"กรรมกร"
		...
		<tr><td  colspan="13" height="10px;"><strong>อาชีพขณะสัมผัสโรค</strong>
...
,14=>"อาสาสมัครฉีดวัคซีนสุนัข",15=>"เจ้าหน้าที่สวนสัตว์",16=>"ไปรษณีย์",17=>"ป่าไม้",18=>"พ่อค้าซื้อขายแลกเปลี่ยนสุนัข แมว สัตว์ป่า",19=>"อื่นๆ",20=>"ไม่ระบุ"); ?>	
		<tr><td  colspan="13" height="10px;"><strong>อาชีพผู้ปกครอง</strong>
		...
		<tr><td  colspan="13" height="10px;"><strong>สถานภาพสัตว์</strong></td></tr>	
		...
		<tr><td  colspan="13" height="10px;"><strong>การฉีดอิมมูโนโกลบุลิน(RIG)</strong></td></tr>
		<tr class="para1">
		...
		<tr><td  colspan="13" height="10px;"><strong>อาการหลังฉีดอิมมูโนโกลบุลิน (RIG)</strong></td></tr>					
		<tr class="para1">
		...
		<tr><td  colspan="13" height="10px;"><strong>วิธีการฉีดวัคซีน</strong></td></tr>
		...
		<tr><td  colspan="13" height="10px;"><strong>ชนิดวัคซีน(จำนวนครั้งที่ใช้)</strong></td></tr>
		...
		<?php endfor; ?>		
		<tr><td  colspan="13" height="10px;"><strong>การแพ้วัคซีน</strong></td></tr>
		<tr class="para1">
