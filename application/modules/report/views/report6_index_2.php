...
<table class="tbreport">
	...
	<tr class="para1">
		...
		<td><?php echo number_format($item['cnt1']);$in  = $item['cnt1']; $total1 =$total1 + $in;?></td>
		<td><?php echo number_format($item['cnt2']);$out = $item['cnt2']; $total2 =$total2 + $out;?></td>
		<td><?php  $all= $in+$out; 
				   $total_all =$total_all + $all;
				   $all1 = $all ; 
				   echo number_format($all1);  ?></td>
	</tr>
	<?php endforeach; ?>
