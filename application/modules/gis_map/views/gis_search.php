...
function mmmap_client_init() {
	...
	mmmap = new MMMap(mmmap_div,18.84326,100.72746,13,'political');
  mmmap.hideScale();
...
<!--</div>-->
     ...
     <form method="get" action="gis_map/gis_search" id="frm1" name="frm1">
		...
		<ul>
			...
			<li><label>การฉีด rig</label><input name="rig" type="radio" value="1" checked="CHECKED">ฉีด<input type="radio" value="2" name="">ไม่ฉีด</li>
...
อัตราการให้วัคซีนป้องกันโรคพิษสุนัขบ้า แยกรายภาค ปี 2556<br>
Comparative Risk Analysis on Post Exposure Prophylaxis by Region, Thailand, 2013<br><br>
 ...
 <br>       
		...
		<div id="tabs3">
			<div id="container"></div>
				...
				var id = <?php echo $map_id; ?>;
				var pid = <?php echo $pro_id; ?>;
				var aid = <?php echo $amp_id; ?>;
				var did = <?php echo $dis_id; ?>;
					
					

				
				$("#show_province").load("gis_map/show_province/"+id);
				
				$("#province").val(<?php echo $pro_id; ?>);
				
				$("#show_amphur").load("gis_map/show_aumphur/"+pid);
				
				$("#amphur").val(<?php echo $amp_id; ?>);
				
				$("#show_district").load("gis_map/show_district/"+pid+"/"+aid);
				
				$("#district").val(<?php echo $dis_id; ?>);
