...
<form id="form1" name="form1" method="post"  action="inform/dead/save" > 
	<?php error_reporting(E_ERROR); 
			...
			@$rs['saliva_headachedate'] = (@$rs['saliva_headachedate'] =='0000-00-00')? '':cld_my2date(@$rs['saliva_headachedate']);		
...
<div id="multiAccordion">
	...
	<div id="section1">
		...
		<tr>
			...
			<tr>
				...
				<td><span class="topic radio">เชื้อชาติ</span>
						<input name="nationality" type="radio" value="1" <? if(@$rs['nationality']=='1'){ echo "checked";}?> onClick="show_hide_nationality(document.form1);"> ไทย&nbsp;&nbsp;
						<input name="nationality" type="radio" value="2" <? if(@$rs['nationality']=='2'){ echo "checked";}?>  onClick="show_hide_nationality(document.form1);"> อื่นๆ 
				...
				<td><span class="topic radio">ศาสนา</span>
					<input type="radio" value="1" name="religion"<? if(@$rs['religion']=='1'){ echo "checked";}?>>พุทธ
					<input type="radio" value="2" name="religion"<? if(@$rs['religion']=='2'){ echo "checked";}?>>คริสต์
					<input type="radio" value="3" name="religion"<? if(@$rs['religion']=='3'){ echo "checked";}?>>อิสลาม
					<input type="radio" value="4" name="religion"<? if(@$rs['religion']=='4'){ echo "checked";}?>>อื่นๆ
				</td>
		...
		<tr>
			<td><span class="topic">เลขที่</span><input type="text"  class="input_box_patient "name="nohome" value="<?php echo $rs['nohome'] ?>"></td>
		...
		<tr>
			...
			<tr>
                <td colspan="4"><p>
						จังหวัด<span class="alertred">*</span> <?php echo form_dropdown('provinceidplace',get_option('province_id','province_name',"n_province where province_id <>'' order by province_name asc"),@$rs['provinceidplace'],'class="styled-select " id="provinceidplace"','-โปรดเลือก-') ?>
						อำเภอ<span id="input_amphur_place">
							...
							$whamphur="";
							 ...
							 echo form_dropdown('amphuridplace',get_option('amphur_id','amphur_name',"n_amphur where $amphur_id $whamphur  order by amphur_name asc"),@$rs['amphuridplace'],'class="styled-select "','-โปรดเลือก-');
							?>
					</span>
					ตำบล <span id="input_district_place">
							...
							$wh="";
							 ...
							 echo form_dropdown('districtidplace',get_option('district_id','district_name',"n_district where $whdistrict $wh  order by district_name asc"),@$rs['districtidplace'],'class="styled-select "','-โปรดเลือก-');
							?>
					 </span>
 					</p>
				  </td>
	...
	<div id="section2">
		<table class="tbdead">
			<tr>
				<th>1. </th>
				<td><span class="topic">วันเริ่มอาการ</span><input type="text" name="startdate" class="input_box_patient datepicker  auto" size="10" value="<?php echo $rs['startdate'] ?>"></td>
				<td><span class="topic">วันที่รักษา</span><input type="text" name="treatdate" class="input_box_patient datepicker  auto" size="10"  value="<?php echo $rs['treatdate'] ?>"></td>
				<td height="20" colspan="4" ><p>
						จังหวัด <?php echo form_dropdown('province_id',get_option('province_id','province_name',"n_province where province_id <>'' order by province_name asc"),@$rs['provinceid'],'class="styled-select " id="province"','-โปรดเลือก-') ?>
						อำเภอ <span id="input_amphur">
							...
							$whamphur="";
							 ...
							 echo form_dropdown('amphur_id',get_option('amphur_id','amphur_name',"n_amphur where $amphur_id $whamphur  order by amphur_name asc"),@$rs['amphurid'],'class="styled-select "','-โปรดเลือก-');
							?>
					</span>
					...
					ตำบล <span id="input_district">
							...
							$wh="";
							 ...
							 echo form_dropdown('district_id',get_option('district_id','district_name',"n_district where $whdistrict $wh  order by district_name asc"),@$rs['districtid'],'class="styled-select "','-โปรดเลือก-');
							?>
					</span>
								...
								$whhospital="";
								 if(@$rs['amphurid']){
										...
										echo form_dropdown('hospital',get_option('hospital_code','hospital_name',"n_hospital_1 where hospital_id<>'' $whhospital ORDER BY hospital_name ASC"),@$rs['hospitalid'],'class="styled-select " ','-โปรดเลือก-');
								 }else{								 										 
							 ?>
			...
			<tr>
				...
				<td><span class="topic">วันที่เสียชีวิต</span>
					 <input type="text" name="endate" class="input_box_patient datepicker  auto" size="10"  value="<?php echo $rs['endate'] ?>">					
				</td>
			<tr>
				<th>3.</th>
				<td colspan="3"><span class="topic" style="width:140px;">อาการและอาการแสดง</span>
					...
					<ul>
						...
						<li><input name="sick" type="radio" value="1"<? if(@$rs['sick']=='1'){ print "checked";}?>  >มี</li>
						<li><input name="sick" type="radio" value="2"<? if(@$rs['sick']=='2'){ print "checked";}?>  >ไม่มี</li>
						<li><input name="sick" type="radio" value="3"<? if(@$rs['sick']=='3'){ print "checked";}?>  >ไม่ทราบ</li>
						<li class="topic">ปวดศีรษะ</li>
						<li><input name="headache" type="radio" value="1"<? if(@$rs['headache']=='1'){ print "checked";}?>  >มี</li>
						<li><input name="headache" type="radio" value="2"<? if(@$rs['headache']=='2'){ print "checked";}?> >ไม่มี</li>
						<li><input name="headache" type="radio" value="3"<? if(@$rs['headache']=='3'){ print "checked";}?>  >ไม่ทราบ</li>
						<li class="topic">ตื่นเต้นกระวนกระวายต่อสิ่งเร้า /แสง /เสียง</li>
						<li><input name="excited_stimuli" type="radio" value="1"<? if(@$rs['excited_stimuli']=='1'){ print "checked";}?>>มี</li>
						<li><input name="excited_stimuli" type="radio" value="2"<? if(@$rs['excited_stimuli']=='2'){ print "checked";}?>>ไม่มี</li>
						<li><input name="excited_stimuli" type="radio" value="3"<? if(@$rs['excited_stimuli']=='3'){ print "checked";}?>>ไม่ทราบ</li>
						<li class="topic">อาละวาดผุดลุกผุดนั่ง</li>
						<li><input name="rampant" type="radio" value="1"<? if(@$rs['rampant']=='1'){ print "checked";}?>>มี</li>
						<li><input name="rampant" type="radio" value="2"<? if(@$rs['rampant']=='2'){ print "checked";}?>>ไม่มี</li>
						<li><input name="rampant" type="radio" value="3"<? if(@$rs['rampant']=='3'){ print "checked";}?>>ไม่ทราบ</li>
						<li class="topic">กลืนลำบาก</li>
						<li><input name="dysphagia" type="radio" value="1"<? if(@$rs['dysphagia']=='1'){ print "checked";}?>>มี</li>
						<li><input name="dysphagia" type="radio" value="2"<? if(@$rs['dysphagia']=='2'){ print "checked";}?>>ไม่มี</li>
						<li><input name="dysphagia" type="radio" value="3"<? if(@$rs['dysphagia']=='3'){ print "checked";}?>>ไม่ทราบ</li>
						<li class="topic">ซึม ไม่รู้สึกตัว</li>
						<li><input name="depress" type="radio" value="1"<? if(@$rs['depress']=='1'){ print "checked";}?>>มี</li>
						<li><input name="depress" type="radio" value="2"<? if(@$rs['depress']=='2'){ print "checked";}?>>ไม่มี</li>
						<li><input name="depress" type="radio" value="3"<? if(@$rs['depress']=='3'){ print "checked";}?>>ไม่ทราบ</li>
						<li class="topic">ถ่มน้ำลายตลอดเวลา</li>
						<li><input name="spit_the_time" type="radio" value="1"<? if(@$rs['spit_the_time']=='1'){ print "checked";}?>>มี</li>
						<li><input name="spit_the_time" type="radio" value="2"<? if(@$rs['spit_the_time']=='2'){ print "checked";}?>>ไม่มี</li>
						<li><input name="spit_the_time" type="radio" value="3"<? if(@$rs['spit_the_time']=='3'){ print "checked";}?>>ไม่ทราบ</li>
						<li class="topic">ถอนหายใจเป็นพักๆ</li>
						<li><input name="sigh_frequently" type="radio" value="1"<? if(@$rs['sigh_frequently']=='1'){ print "checked";}?>>มี</li>
						<li><input name="sigh_frequently" type="radio" value="2"<? if(@$rs['sigh_frequently']=='2'){ print "checked";}?>>ไม่มี</li>
						<li><input name="sigh_frequently" type="radio" value="3"<? if(@$rs['sigh_frequently']=='3'){ print "checked";}?>>ไม่ทราบ</li>
						<li class="topic">กลัวลม</li>
						<li><input name="fear_wind" type="radio" value="1"<? if(@$rs['fear_wind']=='1'){ print "checked";}?>>มี</li>
						<li><input name="fear_wind" type="radio" value="2"<? if(@$rs['fear_wind']=='2'){ print "checked";}?>>ไม่มี</li>
						<li><input name="fear_wind" type="radio" value="3"<? if(@$rs['fear_wind']=='3'){ print "checked";}?>>ไม่ทราบ</li>
						<li class="topic">ขนลุกบางส่วนหรือทั้งตัว</li>
						<li><input name="all_the_burmps" type="radio" value="1"<? if(@$rs['all_the_burmps']=='1'){ print "checked";}?>>มี</li>
						<li><input name="all_the_burmps" type="radio" value="2"<? if(@$rs['all_the_burmps']=='2'){ print "checked";}?>>ไม่มี</li>
						<li><input name="all_the_burmps" type="radio" value="3"<? if(@$rs['all_the_burmps']=='3'){ print "checked";}?>>ไม่ทราบ</li>
						<li class="topic">กลัวน้ำ</li>
						<li><input name="fear_water" type="radio" value="1"<? if(@$rs['fear_water']=='1'){ print "checked";}?>>มี</li>
						<li><input name="fear_water" type="radio" value="2"<? if(@$rs['fear_water']=='2'){ print "checked";}?>>ไม่มี</li>
						<li><input name="fear_water" type="radio" value="3"<? if(@$rs['fear_water']=='3'){ print "checked";}?>>ไม่ทราบ</li>
						<li class="topic">สูญเสียความทรงจำชั่วคราว</li>
						<li><input name="loss_of_memory" type="radio" value="1"<? if(@$rs['loss_of_memory']=='1'){ print "checked";}?>>มี</li>
						<li><input name="loss_of_memory" type="radio" value="2"<? if(@$rs['loss_of_memory']=='2'){ print "checked";}?>>ไม่มี</li>
						<li><input name="loss_of_memory" type="radio" value="3"<? if(@$rs['loss_of_memory']=='3'){ print "checked";}?>>ไม่ทราบ</li>
						<li class="topic">รูม่านตาไม่ตอบสนองต่อแสง</li>
						<li><input name="respond_light" type="radio" value="1"<? if(@$rs['respond_light']=='1'){ print "checked";}?>>มี</li>
						<li><input name="respond_light" type="radio" value="2"<? if(@$rs['respond_light']=='2'){ print "checked";}?>>ไม่มี</li>
						<li><input name="respond_light" type="radio" value="3"<? if(@$rs['respond_light']=='3'){ print "checked";}?>>ไม่ทราบ</li>
						<li class="topic">แขนขาอ่อนแรง</li>
						<li><input name="arm_leg_feeble" type="radio" value="1"<? if(@$rs['arm_leg_feeble']=='1'){ print "checked";}?>>มี</li>
						<li><input name="arm_leg_feeble" type="radio" value="2"<? if(@$rs['arm_leg_feeble']=='2'){ print "checked";}?>>ไม่มี</li>
						<li><input name="arm_leg_feeble" type="radio" value="3"<? if(@$rs['arm_leg_feeble']=='3'){ print "checked";}?>>ไม่ทราบ</li>
					</ul>
				</td>
			</tr>
		...
		<table class="tbdead">
			<tr>
				...
				<td>	<span class="topic radio">เนื้องอกสมอง</span>	
					...
					<td><input name="brain_tumor" type="radio" value="2" onclick="show10(this.value);" <? if(@$rs['brain_tumor']=='2'){ print "checked";}?>>ไม่ได้ส่ง 
					<input name="brain_tumor" type="radio" value="1"<? if(@$rs['brain_tumor']=='1'){ print "checked";}?> onclick="show10(this.value);" >ส่ง</td>	
				<td><span id="brain_tumor" <? if(@$rs['brain_tumor']!='1'){print 'style = "display:none"';  }?>>วันที่ส่งตรวจ <input type="text" class="input_box_patient datepicker  auto" name="brain_tumordate" size="10"  value="<?php echo $rs['brain_tumordate'] ?>"></span></td>	
				<td><span id="brain_tumor_lo"<? if(@$rs['brain_tumor']!='1'){print 'style = "display:none"';  }?>>สถานที่ส่งตรวจ <input type="text" class="input_box_patient" name="brain_tumor_lo"  value="<?php echo $rs['brain_tumor_lo'] ?>"></span></td>
				<td><span id="brain_tumor_po_ne"<? if(@$rs['brain_tumor']!='1'){print 'style = "display:none"';  }?>>
					<input name="brain_tumor_po_ne" type="radio" value="1"<? if(@$rs['brain_tumor_po_ne']=='1'){ print "checked";}?>>Positive
					<input name="brain_tumor_po_ne" type="radio" value="2"<? if(@$rs['brain_tumor_po_ne']=='2'){ print "checked";}?>>Negative</span></td>
				</tr>
			<tr>
				<th>2.</th>
				<td>	<span class="topic radio">น้ำลาย</span>	
				<td><input name="saliva_headache" type="radio" value="2" onclick="show11(this.value);"<? if(@$rs['saliva_headache']=='2'){ print "checked";}?> >ไม่ได้ส่ง
					 <input name="saliva_headache" type="radio" value="1" onclick="show11(this.value);" <? if(@$rs['saliva_headache']=='1'){ print "checked";}?> >ส่ง</td>	
				<td><span id="saliva_headache" <? if(@$rs['saliva_headache']!='1'){print 'style = "display:none"';  }?>>วันที่ส่งตรวจ <input type="text" name="saliva_headachedate" class="input_box_patient datepicker auto" value="<?php echo $rs['saliva_headachedate'] ?>" size="10" ></span></td>	
				<td><span id="saliva_headache_lo" <? if(@$rs['saliva_headache']!='1'){print 'style = "display:none"';  }?>>สถานที่ส่งตรวจ <input type="text" class="input_box_patient" value="<?php echo $rs['saliva_headache_lo'] ?>"  name="saliva_headache_lo"></span></td>
				<td><span id="saliva_headache_po_ne" <? if(@$rs['saliva_headache']!='1'){print 'style = "display:none"';  }?>>
					<input name="saliva_headache_po_ne" type="radio" value="1"<? if(@$rs['saliva_headache_po_ne']=='1'){ print "checked";}?> >Positive
					<input name="saliva_headache_po_ne" type="radio" value="2"<? if(@$rs['saliva_headache_po_ne']=='2'){ print "checked";}?> >Negative</span></td>
			</tr>
			<tr>
				<th>3.</th>
				<td>	<span class="topic radio">น้ำไขสันหลัง</span>	
				<td><input name="csf" type="radio" value="2" onclick="show12(this.value);" <? if(@$rs['csf']=='2'){ print "checked";}?>>ไม่ได้ส่ง 
					<input name="csf" type="radio" value="1"<? if(@$rs['csf']=='1'){ print "checked";}?> onclick="show12(this.value);">ส่ง</td>	
				<td><span id="csf" <? if(@$rs['csf']!='1'){print 'style = "display:none"';  }?>>วันที่ส่งตรวจ <input type="text" class="input_box_patient datepicker  auto" name="csfdate" size="10"  value="<?php echo $rs['csfdate'] ?>"></span></td>	
				<td><span id="csf_lo"<? if(@$rs['csf']!='1'){print 'style = "display:none"';  }?>>สถานที่ส่งตรวจ <input type="text" class="input_box_patient" name="csf_lo" value="<?php echo $rs['csf_lo'] ?>"></span></td>
				<td><span id="csf_po_ne"<? if(@$rs['csf']!='1'){print 'style = "display:none"';  }?>>
					<input name="csf_po_ne" type="radio" value="1"<? if(@$rs['csf_po_ne']=='1'){ print "checked";}?>>Positive
					<input name="csf_po_ne" type="radio" value="2"<? if(@$rs['csf_po_ne']=='2'){ print "checked";}?>>Negative</span></td>
				</tr>
			<tr>
				<th>4.</th>
				<td>	<span class="topic radio">ปัสสาวะ</span>	
				<td><input name="piss" type="radio" value="2" <? if(@$rs['piss']=='2'){ print "checked";}?>onclick="show13(this.value);" >ไม่ได้ส่ง
					 <input name="piss" type="radio" value="1" <? if(@$rs['piss']=='1'){ print "checked";}?> onclick="show13(this.value);">ส่ง</td>	
				<td><span id="piss" <? if(@$rs['piss']!='1'){print 'style = "display:none"';  }?>>วันที่ส่งตรวจ <input type="text" class="input_box_patient datepicker  auto" name="pissdate" size="10" value="<?php echo $rs['pissdate'] ?>"></span></td>	
				<td><span id="piss_lo" <? if(@$rs['piss']!='1'){print 'style = "display:none"';  }?>> สถานที่ส่งตรวจ <input type="text" class="input_box_patient" name="piss_lo" value="<?php echo $rs['piss_lo'] ?>"></span></td>
				<td><span id="piss_po_ne"<? if(@$rs['piss']!='1'){print 'style = "display:none"';  }?>>
					<input name="piss_po_ne" type="radio" value="1"<? if(@$rs['piss_po_ne']=='1'){ print "checked";}?> >Positive
					<input name="piss_po_ne" type="radio" value="2"<? if(@$rs['piss_po_ne']=='2'){ print "checked";}?> >Negative</span></td>
			</tr>
			<tr>
				<th>5.</th>
				<td>	<span class="topic radio">ปมรากผล</span>	
				<td><input name="root" type="radio" value="2"<? if(@$rs['root']=='2'){ print "checked";}?> onclick="show14(this.value);">ไม่ได้ส่ง 
					<input name="root" type="radio" value="1"<? if(@$rs['root']=='1'){ print "checked";}?> onclick="show14(this.value);">ส่ง</td>	
				<td><span id="root" <? if(@$rs['root']!='1'){print 'style = "display:none"';  }?>>วันที่ส่งตรวจ <input type="text" class="input_box_patient datepicker  auto" name="rootdate" value="<?php echo $rs['rootdate'] ?>"size="10"></span></td>	
				<td><span id="root_lo" <? if(@$rs['root']!='1'){print 'style = "display:none"';  }?>>สถานที่ส่งตรวจ <input type="text" class="input_box_patient" name="root_lo"  value="<?php echo $rs['root_lo'] ?>"></td></span>
				<td><span id="root_po_ne" <? if(@$rs['root']!='1'){print 'style = "display:none"';  }?>>
					<input name="root_po_ne" type="radio" value="1"<? if(@$rs['root_po_ne']=='1'){ print "checked";}?> >Positive
					<input name="root_po_ne" type="radio" value="2"<? if(@$rs['root_po_ne']=='2'){ print "checked";}?> >Negative</span></td>
			</tr>
			<tr>
				<th>6.</th>
				...
				<td><input name="occipital_skin" type="radio" value="2" <? if(@$rs['occipital_skin']=='2'){ print "checked";}?>onclick="show15(this.value);" disabled="disabled">ไม่ได้ส่ง 
					<input name="occipital_skin" type="radio" value="1"<? if(@$rs['occipital_skin']=='1'){ print "checked";}?> onclick="show15(this.value);">ส่ง</td>	
				<td><span id="occipital_skin" <? if(@$rs['occipital_skin']!='1'){print 'style = "display:none"';  }?>>วันที่ส่งตรวจ <input type="text" class="input_box_patient datepicker  auto" name="occipital_skindate"  value="<?php echo $rs['occipital_skindate'] ?>"size="10"></span></td>	
				<td><span id="occipital_skin_lo" <? if(@$rs['occipital_skin']!='1'){print 'style = "display:none"';  }?>>สถานที่ส่งตรวจ <input type="text" class="input_box_patient" name="occipital_skin_lo" value="<?php echo $rs['occipital_skin_lo'] ?>"></td></span>
				<td><span id="occipital_skin_po_ne" <? if(@$rs['occipital_skin']!='1'){print 'style = "display:none"';  }?>>
					<input name="occipital_skin_po_ne" type="radio" value="1"<? if(@$rs['occipital_skin_po_ne']=='1'){ print "checked";}?> >Positive
					<input name="occipital_skin_po_ne" type="radio" value="2"<? if(@$rs['occipital_skin_po_ne']=='2'){ print "checked";}?>  >Negative
					</span></td>
			</tr>
			<tr>
				<th>7.</th>
				...
				<td><input name="corneal_cells" type="radio" value="2"<? if(@$rs['corneal_cells']=='2'){ print "checked";}?> onclick="show16(this.value);" disabled="disabled">ไม่ได้ส่ง
					 <input name="corneal_cells" type="radio" value="1" <? if(@$rs['corneal_cells']=='1'){ print "checked";}?> onclick="show16(this.value);">ส่ง</td>	
				<td><span id="corneal_cells" <? if(@$rs['corneal_cells']!='1'){print 'style = "display:none"';  }?>>วันที่ส่งตรวจ <input type="text" class="input_box_patient datepicker  auto" name="corneal_cellsdate" size="10" value="<?php echo $rs['corneal_cellsdate'] ?>"></span></td>	
				<td><span id="corneal_cells_lo" <? if(@$rs['corneal_cells']!='1'){print 'style = "display:none"';  }?>>สถานที่ส่งตรวจ <input type="text" class="input_box_patient" name="corneal_cells_lo" value="<?php echo $rs['corneal_cells_lo'] ?>"></td></span>
				<td><span id="corneal_cells_po_ne" <? if(@$rs['corneal_cells']!='1'){print 'style = "display:none"';  }?>>
					<input name="corneal_cells_po_ne" type="radio" value="1"<? if(@$rs['corneal_cells_po_ne']=='1'){ print "checked";}?> >Positive
					<input name="corneal_cells_po_ne" type="radio" value="2"<? if(@$rs['corneal_cells_po_ne']=='2'){ print "checked";}?> >Negative</span></td>
			</tr>
		</table>		
	</div><!-- section3 -->
	...
	<div id="section4">
		<table class="tbdead">
			<tr><th>1.</th>
					<td><span class="topic">วันที่สัมผัส</span><input type="text" name="datetouch" class="datepicker auto input_box_patient" value="<?php echo $rs['datetouch'] ?>" size="10"> </td>
			</tr>
			<tr>
				<th rowspan="3">3.</th>
			...
			<tr>
				<td rowspan="4">
					...
					<table class="tbreport1" style="width:70%">						
                        ...
                        <td align="center" bgcolor="#FF777A"><input name="head_bite_blood" id="head_bite_noblood" type="radio" <? if(!empty($rs['head_bite_blood'])){ echo 'checked';}?> value="2" onClick="show_mark(document.getElementById('head_bite_blood').checked,document.getElementById('head_bite_noblood').checked,document.getElementById('head_claw_blood').checked,document.getElementById('head_claw_noblood').checked,document.getElementById('head_lick_blood').checked,document.getElementById('head_lick_noblood').checked,document.getElementById('markhead'))"></td>
                        <td align="center" bgcolor="#669966"> <input name="head_claw_blood"  id="head_claw_blood" type="radio"<? if(!empty($rs['head_claw_blood'])){ echo 'checked';}?> 	value="1" 	
                        	onClick="show_mark(document.getElementById('head_bite_blood').checked,document.getElementById('head_bite_noblood').checked,document.getElementById('head_claw_blood').checked,document.getElementById('head_claw_noblood').checked,document.getElementById('head_lick_blood').checked,document.getElementById('head_lick_noblood').checked,document.getElementById('markhead'))"></td>
                        <td align="center" bgcolor="#36CF74"> <input name="head_claw_blood" id="head_claw_noblood" type="radio" <? if(!empty($rs['head_claw_blood'])){ echo 'checked';}?>  value="2" 
                        	onClick="show_mark(document.getElementById('head_bite_blood').checked,document.getElementById('head_bite_noblood').checked,document.getElementById('head_claw_blood').checked,document.getElementById('head_claw_noblood').checked,document.getElementById('head_lick_blood').checked,document.getElementById('head_lick_noblood').checked,document.getElementById('markhead'))"></td>
                        <td align="center" bgcolor="#6394bd"> <input name="head_lick_blood"   id="head_lick_blood"type="radio" <? if(!empty($rs['head_lick_blood'])){ echo 'checked';}?> 	value="1" 	
                        	onClick="show_mark(document.getElementById('head_bite_blood').checked,document.getElementById('head_bite_noblood').checked,document.getElementById('head_claw_blood').checked,document.getElementById('head_claw_noblood').checked,document.getElementById('head_lick_blood').checked,document.getElementById('head_lick_noblood').checked,document.getElementById('markhead'))"></td>
                        <td align="center" bgcolor="#35ADF4"> <input name="head_lick_blood" id="head_lick_noblood"type="radio" <? if(!empty($rs['head_lick_blood'])){ echo 'checked';}?> value="2" 
                        	onClick="show_mark(document.getElementById('head_bite_blood').checked,document.getElementById('head_bite_noblood').checked,document.getElementById('head_claw_blood').checked,document.getElementById('head_claw_noblood').checked,document.getElementById('head_lick_blood').checked,document.getElementById('head_lick_noblood').checked,document.getElementById('markhead'))"></td>
                      </tr>
                      <tr>
                        ...
                        <td align="center" bgcolor="#36CF74"> <input name="face_claw_blood" id="face_claw_noblood" class="one_required" <? if(!empty($rs['face_claw_blood'])){ echo 'checked';}?> type="radio"value="2" onClick="show_mark(document.getElementById('face_bite_blood').checked,document.getElementById('face_bite_noblood').checked,document.getElementById('face_claw_blood').checked,document.getElementById('face_claw_noblood').checked,document.getElementById('face_lick_blood').checked,document.getElementById('face_lick_noblood').checked,document.getElementById('markface'))"></td>
                        ...
                        <td align="center" bgcolor="#35ADF4"> <input name="face_lick_blood"  id="face_lick_noblood"class="one_required"  <? if(!empty($rs['face_lick_blood'])){ echo 'checked';}?> type="radio" value="2" onClick="show_mark(document.getElementById('face_bite_blood').checked,document.getElementById('face_bite_noblood').checked,document.getElementById('face_claw_blood').checked,document.getElementById('face_claw_noblood').checked,document.getElementById('face_lick_blood').checked,document.getElementById('face_lick_noblood').checked,document.getElementById('markface'))"></td>
                      </tr>
                      <tr> 
                        ...
                        <td align="center" bgcolor="#36CF74"> <input name="neck_claw_blood" id="neck_claw_noblood"class="one_required"  <? if(!empty($rs['neck_claw_blood'])){ echo 'checked';}?> type="radio" value="2" onClick="show_mark(document.getElementById('neck_bite_blood').checked,document.getElementById('neck_bite_noblood').checked,document.getElementById('neck_claw_blood').checked,document.getElementById('neck_claw_noblood').checked,document.getElementById('neck_lick_blood').checked,document.getElementById('neck_lick_noblood').checked,document.getElementById('markneck'))"></td>
                        
                        <td align="center" bgcolor="#6394bd"> <input name="neck_lick_blood" id="neck_lick_blood"class="one_required"  <? if(!empty($rs['neck_lick_blood'])){ echo 'checked';}?> type="radio" value="1" onClick="show_mark(document.getElementById('neck_bite_blood').checked,document.getElementById('neck_bite_noblood').checked,document.getElementById('neck_claw_blood').checked,document.getElementById('neck_claw_noblood').checked,document.getElementById('neck_lick_blood').checked,document.getElementById('neck_lick_noblood').checked,document.getElementById('markneck'))"></td>
                        
                        <td align="center" bgcolor="#35ADF4"> <input name="neck_lick_blood" id="neck_lick_noblood" class="one_required"  <? if(!empty($rs['neck_lick_blood'])){ echo 'checked';}?> type="radio" value="2" onClick="show_mark(document.getElementById('neck_bite_blood').checked,document.getElementById('neck_bite_noblood').checked,document.getElementById('neck_claw_blood').checked,document.getElementById('neck_claw_noblood').checked,document.getElementById('neck_lick_blood').checked,document.getElementById('neck_lick_noblood').checked,document.getElementById('markneck'))"></td>
                      ...
                      <tr> 
                        ...
                        <td align="center" bgcolor="#36CF74"> <input name="hand_claw_blood"  id="hand_claw_noblood"class="one_required"  <? if(!empty($rs['hand_claw_blood'])){ echo 'checked';}?> type="radio"  value="2" onClick="show_mark(document.getElementById('hand_bite_blood').checked,document.getElementById('hand_bite_noblood').checked,document.getElementById('hand_claw_blood').checked,document.getElementById('hand_claw_noblood').checked,document.getElementById('hand_lick_blood').checked,document.getElementById('hand_lick_noblood').checked,document.getElementById('markhand'))"></td>
                        
                        <td align="center" bgcolor="#6394bd"> <input name="hand_lick_blood"  id="hand_lick_blood"class="one_required"  <? if(!empty($rs['hand_lick_blood'])){ echo 'checked';}?>  type="radio" value="1" onClick="show_mark(document.getElementById('hand_bite_blood').checked,document.getElementById('hand_bite_noblood').checked,document.getElementById('hand_claw_blood').checked,document.getElementById('hand_claw_noblood').checked,document.getElementById('hand_lick_blood').checked,document.getElementById('hand_lick_noblood').checked,document.getElementById('markhand'))"></td>
                        
                        <td align="center" bgcolor="#35ADF4"> <input name="hand_lick_blood" id="hand_lick_noblood"class="one_required" <? if(!empty($rs['hand_lick_blood'])){ echo 'checked';}?> type="radio" value="2" onClick="show_mark(document.getElementById('hand_bite_blood').checked,document.getElementById('hand_bite_noblood').checked,document.getElementById('hand_claw_blood').checked,document.getElementById('hand_claw_noblood').checked,document.getElementById('hand_lick_blood').checked,document.getElementById('hand_lick_noblood').checked,document.getElementById('markhand'))"></td>
                      ...
                      <tr> 
                        ...
                        <td align="center" bgcolor="#36CF74"> <input name="arm_claw_blood" id="arm_claw_noblood"class="one_required"  <? if(!empty($rs['arm_claw_blood'])){ echo 'checked';}?>  type="radio" value="2" onClick="show_mark(document.getElementById('arm_bite_blood').checked,document.getElementById('arm_bite_noblood').checked,document.getElementById('arm_claw_blood').checked,document.getElementById('arm_claw_noblood').checked,document.getElementById('arm_lick_blood').checked,document.getElementById('arm_lick_noblood').checked,document.getElementById('markarm'))"></td>
                       
                        <td align="center" bgcolor="#6394bd"> <input name="arm_lick_blood" id="arm_lick_blood"class="one_required"  <? if(!empty($rs['arm_lick_blood'])){ echo 'checked';}?> type="radio"  value="1" onClick="show_mark(document.getElementById('arm_bite_blood').checked,document.getElementById('arm_bite_noblood').checked,document.getElementById('arm_claw_blood').checked,document.getElementById('arm_claw_noblood').checked,document.getElementById('arm_lick_blood').checked,document.getElementById('arm_lick_noblood').checked,document.getElementById('markarm'))"></td>
                        
                        <td align="center" bgcolor="#35ADF4"> <input name="arm_lick_blood" id="arm_lick_noblood"class="one_required"  <? if(!empty($rs['arm_lick_blood'])){ echo 'checked';}?> type="radio" value="2" onClick="show_mark(document.getElementById('arm_bite_blood').checked,document.getElementById('arm_bite_noblood').checked,document.getElementById('arm_claw_blood').checked,document.getElementById('arm_claw_noblood').checked,document.getElementById('arm_lick_blood').checked,document.getElementById('arm_lick_noblood').checked,document.getElementById('markarm'))"></td>
                      ...
                      <tr> 
                        ...
                        <td align="center" bgcolor="#36CF74"> <input name="body_claw_blood" id="body_claw_blood"class="one_required"  <? if(!empty($rs['body_claw_blood'])){ echo 'checked';}?> type="radio"  value="2" onClick="show_mark(document.getElementById('body_bite_blood').checked,document.getElementById('body_bite_noblood').checked,document.getElementById('body_claw_blood').checked,document.getElementById('body_claw_noblood').checked,document.getElementById('body_lick_blood').checked,document.getElementById('body_lick_noblood').checked,document.getElementById('markbody'))"></td>
		...
		<table class="tbdead" name="b" id="tbdead5">
			<tr>
				...
				<td class="cn1" id="cn1"><span class="topic radio">ความสะอาดบาดแผล</span>
					<input name="wash" type="radio" value="1"<? if(@$rs['wash']=='1'){ print "checked";}?>onclick="show(this.value);">ไม่ได้ล้าง
					<span class="n_afterwash" id ="notwash"<? if(@$rs['wash']!='1'){print 'style = "display:none"';  }?>> เพราะ
						 <input type="text" name="notwash" value="<? echo $rs['notwash']?>" class="input_box_patient" id="notwash" ></span>
						 
					<input name="wash" type="radio" value="2"<? if(@$rs['wash']=='2'){ print "checked";}?>  onclick="show(this.value);">ล้างทันทีที่ถูกกัด
					<input name="wash" type="radio" value="3" <? if(@$rs['wash']=='3'){ print "checked";}?> onclick="show(this.value);">ล้างหลังจากถูกกัดแล้ว
					<span class="n_afterwash" id ="n_afterwash" <? if(@$rs['wash']!='3'){print 'style = "display:none"';  }?>>
						<input type="text" name="afterwash" class="input_box_patient auto" id="afterwash" size="2"  value="<? echo $rs['afterwash']?>"> ชั่วโมง/วัน </span>
				</td>
			</tr>
			<tr><td colspan="3"><span class="topic radio">วิธีล้างดังนี้</span>
				<input name="washing" type="radio" value="1"<? if(@$rs['washing']=='1'){ print "checked";}?>  onclick="show2(this.value);">ล้างด้วยน้ำเปล่า
				<input name="washing" type="radio" value="2"<? if(@$rs['washing']=='2'){ print "checked";}?>  onclick="show2(this.value);">สบู่/ผงซักฟอก
				<input name="washing" type="radio" value="3"<? if(@$rs['washing']=='3'){ print "checked";}?>  onclick="show2(this.value);">อื่นๆ 
				<span id="otherwashing" <? if(@$rs['washing']!='3'){print 'style = "display:none"';  }?>>ระบุ 
				<input type="text"  name="otherwashing" value="<?echo $rs['otherwashing']?>" id="washing" class="input_box_patient" ></span>
			</td></tr>
			<tr>
				<th>2.</th>
				<td><span class="topic radio">การใช้ยาใส่แผล </span>
					<input name="drugs" type="radio" value="1"<? if(@$rs['drugs']=='1'){ print "checked";}?> onclick="show3(this.value);">ไม่ได้ใช้
					<input name="drugs" type="radio" value="2" <? if(@$rs['drugs']=='2'){ print "checked";}?> onclick="show3(this.value);">ใช้ 
					<span class="n_drugs" id ="n_drugs"<? if(@$rs['drugs']!=='2'){print 'style = "display:none"'; }?>>ระบุชนิด 
					<input type="text" class="input_box_patient" name="usedrugs"  value="<?echo $rs['usedrugs']?>" id="drugs" ></span></td>
			</tr>
		...
		<table class="tbdead">
			<tr>
				...
				<td><span class="topic radio">ฉีดอิมมูโนโกบุลิน</span>					
						<input name="use_rig" type="radio" value="2" <? if(@$rs['use_rig']=='2'){ print "checked";}?> onclick="show4(this.value);" >ไม่ได้ฉีด 
						<input name="use_rig" type="radio" value="1" <? if(@$rs['use_rig']=='1'){ print "checked";}?> onclick="show4(this.value);" >ฉีด 									
							<ul class="sub"><span id="sub" <? if(@$rs['use_rig']!=='1'){print 'style = "display:none"'; }?>>
							<li><input name="inject1_e" type="radio" value="ERIG" <? if(@$rs['inject1_e']=='ERIG'){ echo "checked";}?>>ERIG
								<input name="inject1_e" type="radio" value="HRIG" <? if(@$rs['inject1_e']=='HRIG'){ echo "checked";}?>>HRIG	
								เมื่อวันที่<input type="text" class="input_box_patient datepicker  auto" value="<?php echo $rs['hr_date'] ?>" name="hr_date" size="10"></li>
							<li>จำนวน <input type="text"name="n_userig" class="input_box_patient"  value="<?php echo $rs['logno_userig'] ?>">  IU/kg </li>
							<li>Lot.No <input type="text"  name="logno_userig"class="input_box_patient"  value="<?php echo $rs['logno_userig'] ?>"> </li>
							<li>วันหมดอายุ <input type="text" name="exp_userig" class="input_box_patient datepicker  auto" size="10"  value="<?php echo $rs['exp_userig'] ?>"></li></span></ul>
					</td>
			</tr>
			<tr>
				<th>2.</th>
				<td class="topic"><span class="topic radio">ประวัติการฉีดวัคซีนป้องกันโรค</span>
						<input name="vaccine_text" type="radio" value="1"<? if(@$rs['vaccine_text']=='1'){ print "checked";}?> onclick="show5(this.value);" >ไม่ทราบ
						<input name="vaccine_text" type="radio" value="2" <? if(@$rs['vaccine_text']=='2'){ print "checked";}?>onclick="show5(this.value);" >ไม่ได้ฉีด 
						<input name="vaccine_text" type="radio" value="3"<? if(@$rs['vaccine_text']=='3'){ print "checked";}?> onclick="show5(this.value);">ฉีด 									
							<ul class="sub" id ="h_sub"<? if(@$rs['vaccine_text']!=='3'){print 'style = "display:none"'; }?> >
							<li>ชนิดของวัคซีน ระบุ <?php $vaccine_type =array(1=>'HDCV',2=>'PCEC',3=>'PVRV',4=>'CPRV',5=>'PDEV');
								echo form_dropdown('vaccine_type',$vaccine_type,@$rs['vaccine_type'],'class="styled-select"');
							 ?>								
							</li>
							<li> วันที่เริ่มฉีด <input type="text"  name="vaccine_date"  value="<?echo @$rs['vaccine_date'] ;?>" class="input_box_patient auto datepicker" size="10" > จำนวน <input type="text" class="input_box_patient auto" size="3" name ="sum_vaccine" value="<?echo @$rs['sum_vaccine'] ;?>">ซีซี</li>
							<li> Lot. No. <input type="text" name="vaccine_lotno" class="input_box_patient auto" size="5" value="<?echo @$rs['vaccine_lotno'] ;?>">วันที่หมดอายุ <input type="text" class="input_box_patient auto datepicker" value="<?echo @$rs['exp_vaccine'] ;?>" name="exp_vaccine" size="10"></li>
						</ul> 	
				</td>
			</tr>
		</table>
		...
		<table class="tbdead">
			<tr>
				...
				<td>
					...
					<?echo form_dropdown('animal',$animal,@$rs['animal'],'class="styled-select" ',@$rs['animal']);?>
					<span class="other" <? if(@$rs['animal']!=='6'){print 'style = "display:none"'; }?>>
						<input type="text" name="animal_other" class="input_box_patient" ></span>
				</td> 			
			...
			<tr>
				...
				<td><span class="topic radio">สถานภาพสัตว์</span>
					<input name="statusanimal" type="radio" value="1" <? if(@$rs['statusanimal']=='1'){ echo "checked";}?>>มีเจ้าของ
					<input name="statusanimal" type="radio" value="2" <? if(@$rs['statusanimal']=='2'){ echo "checked";}?>>ไม่มีเจ้าของ
					<input name="statusanimal" type="radio" value="3" <? if(@$rs['statusanimal']=='3'){ echo "checked";}?>>ไม่ทราบ
				</td>
			</tr>
			<tr>
				<th>4.</th>
			...
			<tr>
				...
				<td colspan="3"><span class="topic radio">สาเหตุที่ถูกกัด</span>
					<input name="reasonbite" type="radio" value="1" <? if(@$rs['reasonbite']=='1'){ echo "checked";}?>onclick="show7(this.value);" >ถูกกัดโดยไม่มีสาเหตุโน้นำ
					<input name="reasonbite" type="radio" value="2" <? if(@$rs['reasonbite']=='2'){ echo "checked";}?> onclick="show7(this.value);" >ถูกกัดโดยมีสาเหตุโน้มนำ
					 <span id="subcause_bite" <? if(@$rs['reasonbite']!=='2'){print 'style = "display:none"'; }?>>เนื่องจาก
					 <ul class="sub"  >
					 	<li><input name="n_reasonbite" type="radio" value="1" <? if(@$rs['n_reasonbite']=='1'){ echo "checked";}?> >ทำร้าย หรือแกล้งสัตว์</li>
					 	<li><input name="n_reasonbite" type="radio" value="2" <? if(@$rs['n_reasonbite']=='2'){ echo "checked";}?> >พยายามแยกสัตว์ที่กำลังต่อสู้กัน</li>
					 	<li><input name="n_reasonbite" type="radio" value="3" <? if(@$rs['n_reasonbite']=='3'){ echo "checked";}?> >เข้าใกล้สัตว์แม่ลูกอ่อน</li>
					 	<li><input name="n_reasonbite" type="radio" value="4" <? if(@$rs['n_reasonbite']=='4'){ echo "checked";}?> >รบกวนสัตว์ขณะกินอาหาร</li>
					 	<li><input name="n_reasonbite" type="radio" value="5" <? if(@$rs['n_reasonbite']=='5'){ echo "checked";}?> >อื่นๆ ระบุ 
					 		<input type="text" name="other_reasonbite"class="input_box_patient" value="<? echo $rs['other_reasonbite']?>"></li>					 	
					 </ul>
				</td>
			</tr>
			<tr>
				...
				<td colspan="3"><span class="topic radio">ประวัติการรับวัคซีนของสัตว์นำโรค</span>
					<input name="historyvacine" type="radio" value="1" <? if(@$rs['historyvacine']=='1'){ print "checked";}?> onclick="show8(this.value);">ไม่ทราบ
					<input name="historyvacine" type="radio" value="2" <? if(@$rs['historyvacine']=='2'){ print "checked";}?> onclick="show8(this.value);" >ไม่ได้รับ
					<input name="historyvacine" type="radio" value="3"  <? if(@$rs['historyvacine']=='3'){ print "checked";}?>onclick="show8(this.value);" >ได้รับ
					 <span id="subimmunization_history" <? if(@$rs['historyvacine']!=='3'){print 'style = "display:none"'; }?> >
					 	...
					 	<input name="no1_historyvacine" type="radio" value="ภายใน 1 ปี" <? if(@$rs['no1_historyvacine']=='ภายใน 1 ปี'){ echo "checked";}?> >ภายใน 1 ปี
					 	<input name="no1_historyvacine" type="radio" value="เกิน 1 ปี" <? if(@$rs['no1_historyvacine']=='เกิน 1 ปี '){ echo "checked";}?> >เกิน 1 ปี 
					 	<input name="no1_historyvacine" type="radio" value="จำไม่ได้'" <? if(@$rs['no1_historyvacine']=='จำไม่ได้'){ echo "checked";}?> >จำไม่ได้
					 	</span> 
				</td>
			...
			<tr>
				...
				<td colspan="3"><span class="topic radio">การส่งหัวตรวจ</span>
						<input name="headanimal" type="radio" value="1" <? if(@$rs['headanimal']=='1'){ echo "checked";}?> onclick="show9(this.value);" >ไม่ได้ส่งตรวจเนื่องจาก
						<input name="headanimal" type="radio" value="2" <? if(@$rs['headanimal']=='2'){ echo "checked";}?> onclick="show9(this.value);" >ส่งตรวจเนื่อง 
						...
						<ul class="sub">
							<li>ผลการตรวจ 
								<input name="resultanimal" type="radio" value="พบเชื้อ" <? if(@$rs['resultanimal']=='พบเชื้อ'){ echo "checked";}?> onclick="show9(this.value);" >พบเชื้อ
								<input name="resultanimal" type="radio" value="ไม่พบเชื้อ" <? if(@$rs['resultanimal']=='ไม่พบเชื้อ'){ echo "checked";}?> onclick="show9(this.value);" >ไม่พบเชื้อ
										</li></ul></span>
				</td>
			</tr>
	...
	<div id="section8">
		...
		<tr>
				...
				<tr>
					<td>ผู้สัมผัสโรค<span style="text-decoration: underline"><strong>จากสัตว์ตัวเดียวกัน</strong></span> จำนวน <input type="text"name="same_kind_human" class="input_box_patient" value="<?php echo @$rs['same_kind_human'];?>">คน</td>
					...
					จำนวน<input type="text" class="input_box_patient" name="same_kind_animal"  value="<?php echo @$rs['same_kind_animal'];?>">ตัว</td>
				</tr>
			</tr>
		<tr>
				<th rowspan="2">2.</th>				
				...
				<tr>
					<td>ผู้สัมผัสโรค<span style="text-decoration: underline"><strong>จากผู้ป่วยรายนี้</strong></span> 	<span style="padding-left:24px;">จำนวน</span> 
						<input type="text"name="same_kind_patient" class="input_box_patient" value="<?php echo @$rs['same_kind_patient'];?>">คน</td>
		...
		<table class="tbform">
			<tr>
				<th>ชื่อ-สกุลผู้รายงาน</th><td><input type="text" class="input_box_patient" name="reportname"  value="<?php echo @$rs['reportname'];?>"></td>
				<th>ตำแหน่ง</th><td><input type="text" class="input_box_patient" name="positionname" value="<?php echo @$rs['positionname'];?>"></td>
		   </tr>
		   <tr>
				<th>สถานที่ปฏิบัติงาน</th><td><input type="text" class="input_box_patient" name="reportlocation"  value="<?php echo @$rs['reportlocation'];?>"></td>
				...
				<td>
					<?
						...
						//echo $reportdate;
					?>
			        <input name="reportdate" type="text" size="10" class="input_box_patient "readonly="readonly" value="<?php echo (!empty($rs['reportdate']))? $rs['reportdate']:$reportdate;?>"> 
