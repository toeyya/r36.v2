...
<div class="tab">
    ...
    <div>
        <div style="display:block;">
			...
			<form action="webboards/admin/webboard_quizs/save" method="post" enctype="multipart/form-data">
				<table class="form">
					<tr>
						<th>หมวดหมู่ :</th>
					...
					<tr><th></th><td>
						<?php echo form_hidden("id",$webboard_quizs['id']); 
									echo form_hidden('user_id',$webboard_quizs['user_id']);
						?>
