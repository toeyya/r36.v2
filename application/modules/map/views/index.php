...
<script type="text/javascript" src="http://mmmap15.longdo.com/mmmap/mmmap.php?key=c70798c6ec52d73d51ec03cdae6ac561">
</script>
...
return {"latitude" : newlat, "longitude" : newlong}
    ...
    <body onload="mmmap_client_init()">
        <div id="mmmap_div" style="position: absolute; left: 5px; top: 100px; width: 1270px; height: 156px; border: 0px solid red; text-align: left;">
        
        </div>
        <div id="loading-bar" style="width: 80px; height: 50px; position: absolute; padding: 5px; font-family: Arial,Helvetica; background-color: rgb(255, 255, 255); color: rgb(31, 133, 255); font-weight: bold; text-align: center; visibility: visible; top: 28px; left: 595px;">
	         <div id="loading">
	        	<img src="themes/map/media/images/loadingmove.gif">
	        </div>       
        </div>
