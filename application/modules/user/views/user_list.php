...
<form name="form1"  action="user/search"  method="get" ><!-- ChkAddUser -->		
...
<div id="boxAdd"><a href="user/form" name="btn_add" class="btn_add"></a></div>
<table  class="tb_search_Rabies1" >
	  <tr>
		...
		<th width="19%">สิทธิืการใช้งาน</th>
		<th width="19%">สถานพยาบาล</th>
		<th width="13%">อำเภอ</th>
		<th width="18%">จังหวัด</th>
	  </tr>	  
		<?php foreach($result as $item): ?>
		<tr class="tr_rule_Rabies1">
				<td  align="center"><input name="chk_del[]" type="checkbox" value="<?php echo $item['uid']?>"  class="chk_del"/></td>
				<td><a href="user/form/<?php echo $item['uid'] ?>" alt="แก้ไขข้อมูลผู้ใช้" name="editForm" ><?php echo $item['username'];?></a></td>
		...
		<?php endforeach; ?>
		  <tr>
				<td colspan="8"><input type="button" name="del" value="   ลบ  " class="Submit"></td>
		  </tr>
  </table>
<?php echo $pagination ?>	