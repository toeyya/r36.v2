...
<div id="head_bar">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				  <tr>
					<td width="65%"  bgcolor="#4A8C32" height="20" nowrap="nowrap">			  
					...
					<script type="text/javascript" language="JavaScript1.2">
						...
						stm_ai("p0i0",[0,"หน้าแรก ","","",-1,-1,0,"user/index","_self","","","menu/home.gif","menu/home.gif",16,16,0,"","",0,0,0,0,1,"#4A8C32",0,"#94D87B",0,"","",3,3,0,0,"#ffffff","#ffffff","#ffffff","#000000","8pt 'Courier New','Courier'","8pt 'Courier New','Courier'",0,0]);
						...
						stm_aix("p1i0","p0i0",[0,"แบบฟอร์มคนไข้ที่สัมผัสโรค(ในเขต)","","",-1,-1,0,"inform/index","_self","","","menu/form_blue.gif","menu/form_yellow.gif",-1,-1,0,"","",0,0,0,0,1,"#FFFF99",0,"#FFCC00",0,"","",3,3,0,0,"#ffffff","#ffffff","#333333","#ffffff"]);
						stm_aix("p1i0","p0i0",[0,"แบบฟอร์มคนไข้ที่สัมผัสโรค(นอกเขต)","","",-1,-1,0,"inform/index","_self","","","menu/form_blue.gif","menu/form_blue.gif",-1,-1,0,"","",0,0,0,0,1,"#E7F6E1",0,"#1B4B09",0,"","",3,3,0,0,"#ffffff","#ffffff","#333333","#ffffff"]);
						...
						<? }?>
						<? if($this->session->userdata('R36_LEVEL')=='00'){?>
						stm_aix("p2i1","p0i0",[0,"ค้นหา  / แก้ไข / ลบ ข้อมูล  ","","",-1,-1,0,"hospital/index","_self","","","menu/edit16x16.gif","menu/edit16x16.gif",16,16,0,"","",0,0,0,0,1,"#E7F6E1",0,"#1B4B09",0,"","",3,3,0,0,"#ffffff","#ffffff","#333333","#ffffff","8pt Arial","8pt Arial"]);
						<? }else{?>
						stm_aix("p2i1","p0i0",[0,"ค้นหา /ดู ข้อมูล ","","",-1,-1,0,"hospital/index","_self","","","menu/edit16x16.gif","menu/edit16x16.gif",16,16,0,"","",0,0,0,0,1,"#E7F6E1",0,"#1B4B09",0,"","",3,3,0,0,"#ffffff","#ffffff","#333333","#ffffff","8pt Arial","8pt Arial"]);
						<? }?>
						stm_ep();
						stm_aix("p0i3","p0i1",[]);
						...
						stm_aix("p2i1","p0i0",[0,"ค้นหา  / แก้ไข / ลบ ข้อมูล  ","","",-1,-1,0,"district/index","_self","","","menu/edit16x16.gif","menu/edit16x16.gif",16,16,0,"","",0,0,0,0,1,"#E7F6E1",0,"#1B4B09",0,"","",3,3,0,0,"#ffffff","#ffffff","#333333","#ffffff","8pt Arial","8pt Arial"]);
						<? }else{?>
						stm_aix("p2i1","p0i0",[0,"ค้นหา  /ดู ข้อมูล  ","","",-1,-1,0,"district/index","_self","","","menu/edit16x16.gif","menu/edit16x16.gif",16,16,0,"","",0,0,0,0,1,"#E7F6E1",0,"#1B4B09",0,"","",3,3,0,0,"#ffffff","#ffffff","#333333","#ffffff","8pt Arial","8pt Arial"]);
						<? } ?>
						stm_ep();
						stm_aix("p0i5","p0i1",[]);
						stm_aix("p0i6","p2i1",[0,"ค้นหาข้อมูล ","","",-1,-1,0,"","_self","","","menu/index_view.gif","menu/index_view.gif",16,16,0,"","",0,0,0,0,1,"#4A8C32",0,"#94D87B",0,"","",3,3,0,0,"#ffffff","#ffffff","#ffffff","#000000"]);
						stm_bpx("p6","p1",[]);
						stm_aix("p0i6","p2i1",[0,"ค้นหาข้อมูลผู้สัมผัสหรือสงสัย ","","",-1,-1,0,"search_data/index","_self","","","menu/index_view.gif","menu/index_view.gif",16,16,0,"","",0,0,0,0,1,"#E7F6E1",0,"#1B4B09",0,"","",3,3,0,0,"#ffffff","#ffffff","#333333","#ffffff","8pt Arial","8pt Arial"]);
						...
						stm_aix("p0i6","p2i1",[0,"ค้นหาข้อมูลคนไข้ที่เสียชีวิต ","","",-1,-1,0,"search_data/dead","_self","","","menu/index_view.gif","menu/index_view.gif",16,16,0,"","",0,0,0,0,1,"#E7F6E1",0,"#1B4B09",0,"","",3,3,0,0,"#ffffff","#ffffff","#333333","#ffffff","8pt Arial","8pt Arial"]);
						<? }?>
						stm_ep();
						stm_aix("p0i7","p0i1",[]);
						stm_aix("p0i8","p0i6",[0," วิเคราะห์ข้อมูล ","","",-1,-1,0,"#","_self","","","menu/presentation.gif","menu/presentation.gif",16,16,0,"","",0,0,0,0,1,"#4A8C32",0,"#94D87B",0,"","",3,3,0,0,"#ffffff","#ffffff","#ffffff","#000000"]);
						stm_bpx("p3","p1",[]);
						...
						stm_aix("p4i2","p2i1",[0,"GIS ","","",-1,-1,0,"map/index","_self","","","menu/scroll.gif","menu/scroll.gif"]);
						stm_ep();
						...
						stm_ep();
						stm_aix("p0i9","p0i1",[]);
						stm_aix("p0i10","p0i6",[0,"Help   ","","",-1,-1,0,"#","_self","","","menu/help.gif","menu/help.gif",-1,-1,0,"","",0,0,0,0,1,"#4A8C32",0,"#94D87B",0,"","",3,3,0,0,"#ffffff","#ffffff","#ffffff","#000000"]);
						stm_bpx("p5","p1",[]);
					...
					<script type="text/javascript" language="JavaScript1.2">
						...
						stm_aix("p0i4","p0i0",[0,"ข้อมูลสถานพยาบาล ","","",-1,-1,0,"","_self","","","menu/first_aid.gif","menu/first_aid.gif"]);
						stm_bpx("p2","p1",[]);
						stm_aix("p2i1","p0i0",[0,"ค้นหา /ดู ข้อมูล ","","",-1,-1,0,"hospital/index","_self","","","menu/edit16x16.gif","menu/edit16x16.gif",16,16,0,"","",0,0,0,0,1,"#94D87B",0,"#4A8C32",0,"","",3,3,0,0,"#ffffff","#ffffff","#333333","#ffffff","8pt Arial","8pt Arial"]);
						stm_ep();
						stm_aix("p0i5","p0i1",[]);
						...
						stm_aix("p0i7","p0i1",[]);
						stm_aix("p0i6","p2i1",[0," วิเคราะห์ข้อมูล ","","",-1,-1,0,"#","_self","","","menu/presentation.gif","menu/presentation.gif",16,16,0,"","",0,0,0,0,1,"#4A8C32",0,"#94D87B",0,"","",3,3,0,0,"#ffffff","#ffffff","#ffffff","#000000"]);
						stm_bpx("p3","p1",[]);
						stm_aix("p3i0","p2i1",[0,"วิเคราะห์เชิงพรรณา","","",-1,-1,0,"#","_self","","","menu/text_code.gif","menu/text_code.gif"]);
						stm_bpx("p4","p1",[1,2,-10,10]);
						...
						stm_aix("p5i3","p3i2",[0,"แนวทางเวชปฏิบัติโรคพิษสุนัขบ้า ปี 2556 ","","",-1,-1,0,"lib/jobdog.pdf","_blank","","","menu/download.gif","menu/download.gif"]);
						stm_ep();
						stm_ep();
						stm_em();
					...
					<td width="35%" align="right" bgcolor="#4A8C32" nowrap="nowrap"><span class="top"><?php echo date('H').":".date('i')." น.&nbsp;&nbsp;วันที่ ".date('d').' '.convert_month(date('m'),"shortthai").' '.(date('Y')+543);?> </span>
					</td>
				  </tr>
				</table>
</div>