...
$.googleMaps = {
	...
	mapGeoDesic: function(options) {
		...
		geoDesicDefaults = {
			...
			startLatitude: 	15.432501,
			startLongitude: 100.806884,
			endLatitude:	15.442501,
			endLongitude:	100.816884,			
			color: 			'#ff0000',
			pixels: 		2,
			opacity: 		10
		}
	...
	mapPanOptions: function(options) {
		...
		var panDefaults = {
			...
			panLatitude:	15.432501, 	
			panLongitude:	100.806884,			
			timeout: 		0
		}
